...
function incrementarPorUno(array) { // array 
  ...
  // Tu código:
    ...
    for(let i = 0; i < palabras.length; i++) {
      if ( i === palabras.length - 1) {
        sumString = sumString + palabras[i]
      } else sumString = sumString + palabras[i] + " ";
   } 
   return sumString;
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
    ...
    for (let i = 0; i < resultadosTest.length; i++) {
      sumNotas += resultadosTest[i];
    } return sumNotas / resultadosTest.length;
